...
const PVastAanDeWandNormaleTot4Meter = () => {
  let products = [
    {
      id: 1,
  ...
  return (
    <div className="container">
      <h1>
        Dit zijn de beste keuzes voor een normaal vast projectiescherm tot 150
        inch
      </h1>
...
export default PVastAanDeWandNormaleTot4Meter;
