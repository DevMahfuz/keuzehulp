...
const PVastAanDeWandNormaleTot3Meter = () => {
  let products = [
    {
      id: 1,
  ...
  return (
    <div className="container">
      <h1>
        Dit zijn de beste keuzes voor een normaal vast projectiescherm van 100
        tot 135 inch
      </h1>
...
export default PVastAanDeWandNormaleTot3Meter;
