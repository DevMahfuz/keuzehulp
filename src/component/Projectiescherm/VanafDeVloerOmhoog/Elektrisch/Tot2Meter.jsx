...
const ProjectieschermVanafDeVloerOmhoogElektrischTot2Meter = () => {
  let products = [
    {
      id: 1,
    ...
    },
    {
      ...
      title: "HiViLux Floor Up ALR UST",
      imgURL:
        "https://ls.codetech.nl/shops/299003/files/452759170/700x700x2/hivilux-hivilux-floor-up-alr-ust-tab-tension-92-20.jpg",
      description: `<p class="prodect-description">
          ✔ 92 inch Floor Up<br>
	  ✔ 203 x 114 cm<br>
	  ✔ ALR Scherm<br>
      ...
      link: "https://www.beamer-winkel.nl/hivilux-floor-up-alr-ust-tab-tension-92.html",
    },
    {
      id: 3,
  ...
  return (
    <div className="container">
      <h1>
        Dit zijn de beste keuzes voor een elektrisch vloer scherm van 80 tot 100
        inch
      </h1>
...
export default ProjectieschermVanafDeVloerOmhoogElektrischTot2Meter;
